...
public class MovementControl : MonoBehaviour
{
  ...
  [Header("Sprites")]
    ...
    private AnimatedSpriteRenderer firstSpriteRenderer;

    private void Awake()
    {
        rigidbody = GetComponent<Rigidbody2D>();
        firstSpriteRenderer = spriteRendererDown;
    }
    ...
    private void Update()
    {
        if (Input.GetKey(inputUp)) {
            ...
            SetDirection(Vector2.zero, firstSpriteRenderer);
        }
    }
    ...
    private void SetDirection(Vector2 newDirection, AnimatedSpriteRenderer spriteRenderer)
    {
        ...
        firstSpriteRenderer.idle = direction == Vector2.zero;
    }
}
